...
STREET_ICON_FILES = {
    "ST001":"08-bulgogi.png", "ST002":"19-bibimbap.png", "ST003":"06-dakgui.png",
    "ST004":"16-dwaeji-bulgogi.png", "ST005":"11-samchi.png", "ST006":"09-jangeo.png",
    "ST007":"05-chamge.png", "ST008":"08-bulgogi.png", "ST009":"19-bibimbap.png",
    "ST010":"09-jangeo.png", "ST011":"18-gomtang.png", "ST012":"17-hongeo.png",
    "ST013":"19-bibimbap.png", "ST014":"03-juksun.png", "ST015":"04-gukbap.png",
    "ST016":"21-minuh.png", "ST017":"20-nakji.png", "ST018":"13-bajirak.png",
    "ST019":"07-gopchang.png", "ST020":"04-gukbap.png", "ST021":"06-dakgui.png",
    "ST022":"20-nakji.png", "ST023":"09-jangeo.png", "ST024":"07-gopchang.png",
    "ST025":"05-chamge.png", "ST026":"09-jangeo.png", "ST027":"10-haemul-samhap.png",
    "ST028":"01-gulbi.png", "ST029":"22-dokcheon-nakji.png", "ST030":"14-jeonbok.png",
    "ST031":"02-mirak.png", "ST032":"12-kijogae.png", "ST033":"15-hanwoo.png",
    "ST034":"23-ganjaemi.png", "ST035":"19-bibimbap.png", "ST036":"06-dakgui.png",
}
...
def build_streets() -> list[dict]:
    ...
    for row in _read(STREETS):
        ...
        out.append({
            ...
            "iconPath": f"/street-icons/{STREET_ICON_FILES[row['street_id']]}" if row["street_id"] in STREET_ICON_FILES else None,
            "iconLabel": (row["food_keywords"].split(";")[0] if row["food_keywords"] else row["name"]),
        })
    return out
